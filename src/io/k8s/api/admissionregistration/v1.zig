...
pub const MutatingAdmissionPolicy = struct {
    ...
    spec: ?root.io.k8s.api.admissionregistration.v1.MutatingAdmissionPolicySpec = null,
...
pub const MutatingAdmissionPolicyBinding = struct {
    ...
    spec: ?root.io.k8s.api.admissionregistration.v1.MutatingAdmissionPolicyBindingSpec = null,
...
pub const MutatingAdmissionPolicyBindingList = struct {
    ...
    items: []const root.io.k8s.api.admissionregistration.v1.MutatingAdmissionPolicyBinding,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
...
pub const MutatingAdmissionPolicyList = struct {
    ...
    items: []const root.io.k8s.api.admissionregistration.v1.MutatingAdmissionPolicy,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// metadata is the standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    metadata: ?root.io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta = null,
...
pub const MutatingAdmissionPolicySpec = struct {
    ...
    mutations: ?[]const root.io.k8s.api.admissionregistration.v1.Mutation = null,
...
pub const Mutation = struct {
    ...
    applyConfiguration: ?root.io.k8s.api.admissionregistration.v1.ApplyConfiguration = null,
    ...
    jsonPatch: ?root.io.k8s.api.admissionregistration.v1.JSONPatch = null,

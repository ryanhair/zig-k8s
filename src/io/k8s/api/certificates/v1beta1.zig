...
pub const PodCertificateRequestSpec = struct {
    ...
    pkixPublicKey: ?[]const u8 = null,
    /// podName is the name of the pod into which the certificate will be mounted.
    podName: []const u8,
    /// podUID is the UID of the pod into which the certificate will be mounted.
    podUID: []const u8,
    /// proofOfPossession is a proof that the requesting kubelet holds the private key corresponding to pkixPublicKey.
    ///
    ...
    proofOfPossession: ?[]const u8 = null,

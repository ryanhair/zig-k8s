...
pub const AllocatedDeviceStatus = struct {
    ...
    networkData: ?root.io.k8s.api.resource.v1beta1.NetworkDeviceData = null,
...
pub const Device = struct {
    ...
    pub fn validate(self: @This()) !void {
        if (self.basic) |v| try v.validate();
    }
};
...
pub const DeviceClass = struct {
    ...
    spec: root.io.k8s.api.resource.v1beta1.DeviceClassSpec,
...
pub const DeviceClassList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta1.DeviceClass,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
...
pub const ResourceClaim = struct {
    ...
    spec: root.io.k8s.api.resource.v1beta1.ResourceClaimSpec,
...
pub const ResourceClaimList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta1.ResourceClaim,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?root.io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta = null,
...
pub const ResourceClaimStatus = struct {
    ...
    reservedFor: ?[]const root.io.k8s.api.resource.v1beta1.ResourceClaimConsumerReference = null,
...
pub const ResourceClaimTemplate = struct {
    ...
    spec: root.io.k8s.api.resource.v1beta1.ResourceClaimTemplateSpec,
...
pub const ResourceClaimTemplateList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta1.ResourceClaimTemplate,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?root.io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta = null,
...
pub const ResourceSliceList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta1.ResourceSlice,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?root.io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta = null,

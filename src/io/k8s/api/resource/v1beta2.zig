...
pub const AllocatedDeviceStatus = struct {
    ...
    networkData: ?root.io.k8s.api.resource.v1beta2.NetworkDeviceData = null,
...
pub const AllocationResult = struct {
    ...
    devices: ?root.io.k8s.api.resource.v1beta2.DeviceAllocationResult = null,
...
pub const CapacityRequestPolicy = struct {
    ...
    validRange: ?root.io.k8s.api.resource.v1beta2.CapacityRequestPolicyRange = null,
...
pub const Device = struct {
    ...
    consumesCounters: ?[]const root.io.k8s.api.resource.v1beta2.DeviceCounterConsumption = null,
    ...
    taints: ?[]const root.io.k8s.api.resource.v1beta2.DeviceTaint = null,
...
pub const DeviceAllocationConfiguration = struct {
    ...
    @"opaque": ?root.io.k8s.api.resource.v1beta2.OpaqueDeviceConfiguration = null,
...
pub const DeviceAllocationResult = struct {
    ...
    config: ?[]const root.io.k8s.api.resource.v1beta2.DeviceAllocationConfiguration = null,
    /// results lists all allocated devices.
    results: ?[]const root.io.k8s.api.resource.v1beta2.DeviceRequestAllocationResult = null,
...
pub const DeviceCapacity = struct {
    ...
    requestPolicy: ?root.io.k8s.api.resource.v1beta2.CapacityRequestPolicy = null,
...
pub const DeviceClaim = struct {
    ...
    config: ?[]const root.io.k8s.api.resource.v1beta2.DeviceClaimConfiguration = null,
    /// constraints must be satisfied by the set of devices that get allocated for the claim.
    constraints: ?[]const root.io.k8s.api.resource.v1beta2.DeviceConstraint = null,
    /// requests represent individual requests for distinct devices which must all be satisfied. If empty, nothing needs to be allocated.
    requests: ?[]const root.io.k8s.api.resource.v1beta2.DeviceRequest = null,
...
pub const DeviceClassList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta2.DeviceClass,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
...
pub const DeviceClassSpec = struct {
    ...
    config: ?[]const root.io.k8s.api.resource.v1beta2.DeviceClassConfiguration = null,
    ...
    selectors: ?[]const root.io.k8s.api.resource.v1beta2.DeviceSelector = null,
...
pub const DeviceRequest = struct {
    ...
    exactly: ?root.io.k8s.api.resource.v1beta2.ExactDeviceRequest = null,
    ...
    firstAvailable: ?[]const root.io.k8s.api.resource.v1beta2.DeviceSubRequest = null,
...
pub const DeviceRequestAllocationResult = struct {
    ...
    /// Must be a DNS subdomain and should end with a DNS domain owned by the vendor of the driver. It should use only lower case characters.
    driver: []const u8,
    /// pool together with the driver name and the device name field identify which device was allocated (`<driver name>/<pool name>/<device name>`).
    ///
    /// Must not be longer than 253 characters and may contain one or more DNS sub-domains separated by slashes.
    pool: []const u8,
    ...
    ///
    /// This is a beta field and requires enabling the DRADeviceTaints feature gate.
    tolerations: ?[]const root.io.k8s.api.resource.v1beta2.DeviceToleration = null,
...
pub const DeviceSelector = struct {
    ...
    cel: ?root.io.k8s.api.resource.v1beta2.CELDeviceSelector = null,
...
pub const DeviceSubRequest = struct {
    ...
    capacity: ?root.io.k8s.api.resource.v1beta2.CapacityRequirements = null,
    ...
    derivedAttributes: ?[]const root.io.k8s.api.resource.v1beta2.DeviceDerivedAttribute = null,
...
pub const DeviceTaintRule = struct {
    ...
    ///
    /// Changing the spec automatically increments the metadata.generation number.
    spec: root.io.k8s.api.resource.v1beta2.DeviceTaintRuleSpec,
    /// status provides information about what was requested in the spec.
    status: ?root.io.k8s.api.resource.v1beta2.DeviceTaintRuleStatus = null,
...
pub const DeviceTaintRuleList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta2.DeviceTaintRule,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?root.io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta = null,
...
pub const DeviceTaintRuleSpec = struct {
    ...
    deviceSelector: ?root.io.k8s.api.resource.v1beta2.DeviceTaintSelector = null,
    /// taint is the taint that gets applied to matching devices.
    taint: root.io.k8s.api.resource.v1beta2.DeviceTaint,
...
pub const DeviceTaintSelector = struct {
    /// device is the device name. If device is set, only devices with that name are selected. This field corresponds to slice.spec.devices[].name.
    ///
...
pub const NodeAllocatableResource = struct {
    ...
    mapping: ?root.io.k8s.api.resource.v1beta2.NodeAllocatableMapping = null,
    ...
    overhead: ?root.io.k8s.api.resource.v1beta2.NodeAllocatableOverhead = null,

    pub fn validate(self: @This()) !void {
        if (self.mapping) |v| try v.validate();
...
pub const ResourceClaimList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta2.ResourceClaim,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?root.io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta = null,
...
pub const ResourceClaimSpec = struct {
    ...
    devices: ?root.io.k8s.api.resource.v1beta2.DeviceClaim = null,
...
pub const ResourceClaimStatus = struct {
    ...
    allocation: ?root.io.k8s.api.resource.v1beta2.AllocationResult = null,
    /// devices contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.
    devices: ?[]const root.io.k8s.api.resource.v1beta2.AllocatedDeviceStatus = null,
    ...
    reservedFor: ?[]const root.io.k8s.api.resource.v1beta2.ResourceClaimConsumerReference = null,
...
pub const ResourceClaimTemplateList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta2.ResourceClaimTemplate,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?root.io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta = null,
...
pub const ResourceSlice = struct {
    ...
    ///
    /// Changing the spec automatically increments the metadata.generation number.
    spec: root.io.k8s.api.resource.v1beta2.ResourceSliceSpec,
...
pub const ResourceSliceList = struct {
    ...
    items: []const root.io.k8s.api.resource.v1beta2.ResourceSlice,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?root.io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta = null,
...
pub const ResourceSliceSpec = struct {
    ...
    devices: ?[]const root.io.k8s.api.resource.v1beta2.Device = null,
    ...
    pool: root.io.k8s.api.resource.v1beta2.ResourcePool,
    ...
    sharedCounters: ?[]const root.io.k8s.api.resource.v1beta2.CounterSet = null,

...
pub const Device = struct {
    ...
    nodeAllocatableResourceMappings: ?std.json.Value = null,
...
pub const NodeAllocatableResourceMapping = struct {
    ...
    allocationMultiplier: ?root.io.k8s.apimachinery.pkg.api.resource.Quantity = null,

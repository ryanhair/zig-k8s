...
pub const StorageVersionMigration = struct {
    ...
    spec: ?root.io.k8s.api.storagemigration.v1.StorageVersionMigrationSpec = null,
    /// Status of the migration.
    status: ?root.io.k8s.api.storagemigration.v1.StorageVersionMigrationStatus = null,
...
pub const StorageVersionMigrationList = struct {
    ...
    items: []const root.io.k8s.api.storagemigration.v1.StorageVersionMigration,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
